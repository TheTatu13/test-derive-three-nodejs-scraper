...
Open a [GitHub Issue](https://github.com/TheTatu13/test-derive-three-nodejs-scraper/issues) with:
...
- the company's own careers listing (`https://example.com/careers`) + its job sitemap (``)
- ANOFM (by CIF)
