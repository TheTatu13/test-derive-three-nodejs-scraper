...
```bash
gh issue list --repo TheTatu13/test-derive-three-nodejs-scraper --state open
```
...
- `docs/test-results/index.html` — branding must say "TEST DERIVE THREE SRL", not the old template
