...
This scraper extracts job listings for **TEST DERIVE THREE SRL** (CIF: 77777777) from the company's own careers site and from ANOFM, and imports them to peviitor.ro.

Targets: https://example.com/careers, , https://mediere.anofm.ro
...
- **TestDeriveThree — listing**: `https://example.com/careers` — pagina publică de posturi deschise (HTML server-rendered)
- **TestDeriveThree — sitemap**: `` — permalink-uri canonice `/joburi/<slug>/`
